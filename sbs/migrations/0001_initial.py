# Generated by Django 2.2.6 on 2021-02-22 16:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('date', 'Date'), ('string', 'String'), ('number', 'Number')],
                                          default='string', max_length=128, verbose_name='Kan Grubu')),
                ('birim', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                                               to='sbs.Abirim')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.IntegerField(
                    choices=[(0, 'YURT İÇİ FAALİYETLERİ'), (1, 'YURT DIŞI FAALİYETLERİ'), (2, 'EGİTİM FAALİYETLERİ'),
                             (3, 'KAMP FAALİYETLERİ')], db_column='Type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('oda', models.CharField(blank=True, max_length=120, null=True)),
                ('dolap', models.CharField(blank=True, max_length=120, null=True)),
                ('raf', models.CharField(blank=True, max_length=120, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Athlete',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('branch', models.CharField(blank=True, choices=[('BADMİNTON', 'BADMİNTON')], max_length=128, null=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.CharField(
                    choices=[('SPOR BİLGİ SİSTEMİ', 'SPOR BİLGİ SİSTEMİ'), ('MOBİL UYGULAMA', 'MOBİL UYGULAMA'),
                             ('WEB SİTE', 'WEB SİTE')], default='SPOR BİLGİ SİSTEMİ', max_length=128,
                    verbose_name='Proje Seçiniz')),
                ('status', models.CharField(blank=True, choices=[('Onaylandı', 'Onaylandı'),
                                                                 ('İşlem Devam Ediliyor', 'İşlem Devam Ediliyor'),
                                                                 ('Reddedildi', 'Reddedildi'),
                                                                 ('Beklemede', 'Beklemede')], default='Beklemede',
                                            max_length=128, null=True, verbose_name='Kayıt Durumu')),
                ('definition', models.CharField(max_length=1000)),
                ('importanceSort',
                 models.CharField(choices=[('ACİL', 'ACİL'), ('ÖNEMLİ', 'ÖNEMLİ'), ('AZ ÖNEMLİ', 'AZ ÖNEMLİ')],
                                  default='ACİL', max_length=128, verbose_name='Önem Durumu')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(
                    ...
                    max_length=128, verbose_name='Kayıt Durumu')),
                ('dekont',
                 models.FileField(blank=True, null=True, upload_to='dekont/', verbose_name='coachApplication ')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city',
                 models.ForeignKey(blank=True, db_column='city', null=True, on_delete=django.db.models.deletion.CASCADE,
                                   to='sbs.City', verbose_name='İl')),
            ],
        ),
        migrations.CreateModel(
            name='Competition',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('compType', models.IntegerField(blank=True, choices=[(0, 'Üniversiteler Arası'), (1, 'Okullar Arası'),
                                                                      (2, 'Ferdi')], db_column='compType', null=True)),
                ('creationDate', models.DateTimeField(auto_now_add=True, db_column='creationDate', null=True)),
                ('operationDate', models.DateTimeField(auto_now_add=True, db_column='operationDate', null=True)),
                ('finishDate', models.DateTimeField(blank=True, db_column='finishDate', null=True)),
                ('startDate', models.DateTimeField(blank=True, db_column='startDate', null=True)),
                ...
                ('compGeneralType', models.IntegerField(blank=True,
                                                        choices=[(0, 'Türkiye'), (1, 'Dünya'), (2, 'Olimpiyat'),
                                                                 (3, 'Avrupa')], db_column='compGeneralType',
                                                        null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('oldpk', models.IntegerField(blank=True, null=True)),
                ('communication',
                 models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='sbs.Communication')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(
                    ...
                    max_length=128, verbose_name='Kayıt Durumu')),
                ('dekont',
                 models.FileField(blank=True, null=True, upload_to='dekont/', verbose_name='judgeApplication ')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bloodType', models.CharField(blank=True,
                                               choices=[('AB(+)', 'AB Rh+'), ('AB(-)', 'AB Rh-'), ('A(+)', 'A Rh+'),
                                                        ('A(-)', 'A Rh-'), ('B(+)', 'B Rh+'), ('B(-)', 'B Rh-'),
                                                        ('0(+)', '0 Rh+'), ('0(-)', '0 Rh-')], max_length=128,
                                               null=True, verbose_name='Kan Grubu')),
                ...
                ('education', models.IntegerField(blank=True,
                                                  choices=[(10, 'İlkokul'), (15, 'Lise'), (25, 'Üniversite(Lisans)'),
                                                           (30, 'Yüksek Lisans'), (20, 'Yüksek Okul')], null=True)),
                ('mezunokul', models.CharField(blank=True, max_length=200, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(blank=True, choices=[('RAKET', 'RAKET'), ('TOPLAR', 'TOPLAR'),
                                                                   ('AYAKKABI', 'AYAKKABI'), ('CANTA', 'ÇANTA'),
                                                                   ('AKSESUAR', 'AKSESUAR'), ('GRİP', 'GRİP'),
                                                                   ('KORDAJ', 'KORDAJ'), ('EKİPMAN', 'EKİPMAN'),
                                                                   ('KIYAFET', 'KIYAFET'), ('TISORT', 'TISORT'),
                                                                   ('KITAP', 'KİTAP')], max_length=128, null=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sbs.ClubRole',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('forWhichClazz', models.CharField(max_length=255)),
                ('application',
                 models.BooleanField(blank=True, choices=[(True, 'Açık'), (False, 'Kapalı')], default=False,
                                     null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('operationDate', models.DateTimeField(auto_now=True)),
                ('isFormal',
                 models.BooleanField(choices=[(True, 'Spor Kulubü'), (False, 'Diger(Özel Salon-Dojo-Sportif Dernek)')],
                                     default=True)),
                ('dataAccessControl', models.BooleanField(blank=True, default=False, null=True)),
                ...
                ('communication', models.OneToOneField(blank=True, db_column='communication', null=True,
                                                       on_delete=django.db.models.deletion.CASCADE,
                                                       to='sbs.Communication')),
            ],
        ),
        migrations.CreateModel(
            name='SandaAthlete',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birthDate', models.DateField(blank=True, null=True, verbose_name='Doğum Tarihi')),
                ('bloodType', models.CharField(blank=True,
                                               choices=[('AB Rh+', 'AB Rh+'), ('AB Rh-', 'AB Rh-'), ('A Rh+', 'A Rh+'),
                                                        ('A Rh-', 'A Rh-'), ('B Rh+', 'B Rh+'), ('B Rh-', 'B Rh-'),
                                                        ('AB Rh+', '0 Rh+'), ('AB Rh+', '0 Rh-')], max_length=128,
                                               null=True, verbose_name='Kan Grubu')),
                ('gender',
                ...
                ('kademe_definition',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sbs.CategoryItem')),
            ],
        ),
        migrations.CreateModel(
            name='ReferenceCoach',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='sbs.ClubRole',
                                           verbose_name='Üye Rolü')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fa_icon', models.CharField(blank=True, max_length=120, null=True)),
                ('parent',
                 models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='sbs.Menu')),
                ('permission', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
                                                    related_name='MenuPermission', to='auth.Permission')),
            ],
        ),
        migrations.CreateModel(
            name='Logs',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cityHeadShip', models.ForeignKey(blank=True, db_column='cityHeadShip', null=True,
                                                   on_delete=django.db.models.deletion.CASCADE, to='sbs.City')),
                ('coach', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
                                            related_name='antrenor1', to='sbs.Coach')),
                ('coach2', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                                             related_name='antrenor2', to='sbs.Coach')),
                ('sportsClub', models.ForeignKey(db_column='sportsClub', on_delete=django.db.models.deletion.CASCADE,
                                                 to='sbs.SportsClub')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modificationDate', models.DateTimeField(auto_now=True)),
                ('levelType',
                 models.CharField(choices=[('VISA', 'VISA'), ('GRADE', 'GRADE'), ('BELT', 'BELT')], max_length=128,
                                  verbose_name='Leveller')),
                ('branch', models.CharField(blank=True, choices=[('BADMİNTON', 'BADMİNTON')], max_length=128, null=True,
                                            verbose_name='Branş')),
                ('isActive', models.BooleanField(default=False)),
                ('startDate', models.DateField(blank=True, null=True)),
                ...
                ('city',
                 models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='sbs.City',
                                   verbose_name='İl')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('jurymemberthree',
                 models.CharField(blank=True, db_column='juryMemberThree', max_length=255, null=True)),
                ...
                ('techcontrollerone',
                 models.CharField(blank=True, db_column='techControllerOne', max_length=255, null=True)),
                ('techcontrollertwo',
                 models.CharField(blank=True, db_column='techControllerTwo', max_length=255, null=True)),
                ('timekeeper', models.CharField(blank=True, db_column='timeKeeper', max_length=255, null=True)),
                ('competition', models.ForeignKey(blank=True, db_column='competition', null=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('oldpk', models.IntegerField(blank=True, null=True)),
                ('commission',
                 models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='sbs.DirectoryCommission',
                                   verbose_name='Kurulu')),
                ('communication',
                 models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='sbs.Communication')),
                ('person', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='sbs.Person')),
                ('role', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sbs.DirectoryMemberRole',
                                           verbose_name='Üye Rolü')),
                (
                'user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('club', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                                           to='sbs.SportsClub', verbose_name='Emanet Kulup')),
                ('product', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                                              to='sbs.Products', verbose_name='Emanet Malzeme')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grupid', models.IntegerField(blank=True, null=True)),
                ('athlete',
                 models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='athlete',
                                   to='sbs.Athlete')),
                ('athleteTwo',
                 models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='athlete2',
                                   to='sbs.Athlete')),
                ('category',
                 models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='sbs.Category')),
                ('club',
                 models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='sbs.SportsClub')),
                ('coach', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='sbs.Coach')),
                ('competition',
                 models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='sbs.Competition')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('competition', models.ForeignKey(blank=True, db_column='competition', null=True,
                                                  on_delete=django.db.models.deletion.SET_NULL, to='sbs.Competition')),
                ('grupforreport', models.ForeignKey(blank=True, db_column='grupForReport', null=True,
                                                    on_delete=django.db.models.deletion.DO_NOTHING,
                                                    to='sbs.GrupForReport')),
            ],
        ),
        migrations.CreateModel(
            name='CompAthlete',
            fields=[
                ...
                ('athlete', models.ForeignKey(blank=True, db_column='athlete', null=True,
                                              on_delete=django.db.models.deletion.DO_NOTHING, to='sbs.Athlete')),
                ('category', models.ForeignKey(blank=True, db_column='category', null=True,
                                               on_delete=django.db.models.deletion.DO_NOTHING, to='sbs.Category')),
                ('compcategory', models.ForeignKey(blank=True, db_column='compCategory', null=True,
                                                   on_delete=django.db.models.deletion.DO_NOTHING,
                                                   to='sbs.CompCategory')),
                ('competition', models.ForeignKey(blank=True, db_column='competition', null=True,
                                                  on_delete=django.db.models.deletion.DO_NOTHING,
        ...
        migrations.AddField(
            ...
            name='country',
            field=models.ForeignKey(blank=True, db_column='country', null=True,
                                    on_delete=django.db.models.deletion.CASCADE, to='sbs.Country', verbose_name='Ülke'),
        ),
        migrations.AddField(
            model_name='coach',
            name='communication',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('paymentType',
                 models.CharField(choices=[('Banka', 'Banka'), ('Posta', 'Posta')], default='Banka', max_length=128,
        ...
        migrations.AddField(
            model_name='athlete',
            name='communication',
            field=models.OneToOneField(db_column='communication', on_delete=django.db.models.deletion.CASCADE,
                                       to='sbs.Communication'),
        ),
        migrations.AddField(
            model_name='athlete',
        ...
        migrations.AddField(
            model_name='athlete',
            name='person',
            field=models.OneToOneField(db_column='person', on_delete=django.db.models.deletion.CASCADE,
                                       to='sbs.Person'),
        ),
        migrations.AddField(
            model_name='athlete',
            name='user',
            field=models.OneToOneField(db_column='user', on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birim', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                                               to='sbs.Abirim')),
                ('location', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                                                  to='sbs.Alocation')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('date', 'Date'), ('string', 'String'), ('number', 'Number')],
                                          default='string', max_length=128, verbose_name='Kan Grubu')),
                ('dosya', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                                               to='sbs.Adosya')),
                ('parametre', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='auth.Group',
                                            verbose_name='aktivGroup')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL,
                                           verbose_name='aktivUser')),
            ],
        ),
    ]
