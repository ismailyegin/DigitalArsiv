    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('date', 'Date'), ('string', 'String'), ('number', 'Number')], default='string', max_length=128, verbose_name='Kan Grubu')),
                ('birim', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='sbs.Abirim')),
            ],
        ),
        migrations.CreateModel(
            name='Activity',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('Onaylandı', 'Onaylandı'), ('İşlem Devam Ediliyor', 'İşlem Devam Ediliyor'), ('Reddedildi', 'Reddedildi'), ('Beklemede', 'Beklemede')], default='Beklemede', max_length=128, null=True, verbose_name='Kayıt Durumu')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sirano', models.IntegerField(blank=True, null=True)),
                ('birim', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='sbs.Abirim')),
                ('location', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='sbs.Alocation')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('date', 'Date'), ('string', 'String'), ('number', 'Number')], default='string', max_length=128, verbose_name='Kan Grubu')),
                ('dosya', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='sbs.Adosya')),
                ('parametre', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='sbs.AbirimParametre')),
            ],
        ),
        migrations.AddField(
            model_name='adosya',
        ...
        migrations.AddField(
            model_name='adosya',
            name='klasor',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='sbs.Aklasor'),
        ),
        migrations.CreateModel(
            name='ActiveGroup',
            fields=[
